...
<body class="feature-body">
    ...
    <section class="all-information" id="all-information">
        <div class="all-information-container">
            ...
            <form class="info-search-box" action="search.php" method="POST">
                <div class="search-box">
                    <i class="fa-solid fa-magnifying-glass"></i>
                    <input type="text" name="searchword" id="info-search" class="id-search" placeholder="Search" />
                </div>
                <!-- <select id="info-country-select" class="info-country-select">
            ...
            <div class="all-cards">
                ...
                <?php
                    if (isset($_POST['search'])) {
                        ...
                        $query = "SELECT packagedetail.*,packages.*,packagetypes.*,country.* FROM packagedetail,packages,packagetypes,country WHERE packagedetail.PKID=packages.PKID AND packagedetail.PKTID=packagetypes.PKTID AND packages.CountryID=country.CountryID AND packages.PKName LIKE '%$data%' ORDER BY PDetailID DESC";
