...
<body class="feature-body userbody">
    ...
    <section class="all-information" id="all-information">
        <div class="all-information-container">
            <h1 class="all-information-title">All Campsites from GWSC</h1>
            <form class="info-search-box"  action="search.php" method="POST">
                <div class="search-box">
                    <i class="fa-solid fa-magnifying-glass"></i>
                    <input type="text" name="searchword" id="info-search" class="id-search" placeholder="Search" required/>
                </div>
                ...
                <button name="search" class="info-search-link">Search</button>
            </form>
            <div class="all-cards">
                ...
                while($out = mysqli_fetch_array($go_query)){
                    ...
                    if (!($startDate < $currentDate) && $status == 0 && $noOfPeople > 0) {
                         echo '
                    ...
                    ';
                        ...
                        echo '
                        <a href="./detail.php?id=' . $pdetailID . '" class="all-card unavailable">
                            <img src="./photo/' . $img1 . '" alt="" class="all-card-img" />
                            <div class="name-and-views">
                                <p class="all-card-name">' . substr("$pkName", 0, 25) . '</p>
    ...
    <footer>
        <div class="footer-container">
            <div class="you-are-here">
                ...
                <a href="" class="footer-nav-item">All Pitch</a>
            </div>
